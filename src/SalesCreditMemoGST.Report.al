report 50103 "Sales Credit Memo GST India"
{
    Caption = 'Credit Memo (GST India)';
    DefaultLayout = RDLC;
    RDLCLayout = 'src/SalesCreditMemoGST.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(CreditMemoDate; "Posting Date") { }
    ...
    labels
    {
        CreditMemoTitleLbl = 'CREDIT MEMO';
        CreditMemoNoLbl = 'Credit Memo No.';
        CreditMemoDateLbl = 'Date';
        OriginalInvoiceLbl = 'Original Invoice';
        ReasonLbl = 'Reason for Credit';
    }
