report 50102 "Sales Order GST India"
{
    Caption = 'Sales Order (GST India)';
    DefaultLayout = RDLC;
    RDLCLayout = 'src/SalesOrderGST.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                // Totals calculated during line processing for RDLC Last() access
                column(RunningTotalGST; TotalGSTAmount) { }
                column(RunningGrandTotal; GrandTotal) { }
                column(RunningAmountInWords; AmountInWords) { }
                ...
                begin
                    ...
                    // Calculate totals here so RDLC can access them via Last()
